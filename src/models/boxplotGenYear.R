...
mse <- data.frame(
  CATE_1990S = tauhat_cf_test1,
  CATE_2000S = tauhat_cf_test2,
  CATE_2010S = tauhat_cf_test3
)

boxplot(mse, ylab = "CATE", main='CATE by year (forest w/ 100 trees)')
summary(mse)
apply(mse, 2, sd)
